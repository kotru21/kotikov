...
const Logo: React.FC<LogoProps> = ({ variant = "pc", className = "" }) => {
  ...
  return (
    ...
    >
      ...
      <path
        fill="#00b583"
        d="M231.5 45C202.655 87.876 185 108.847 185 134.071C185 159.294 205.925 179 232.275 179C258.625 179 278 156.929 278 134.071C278 111.212 257.576 84.4935 231.5 45Z"
      />
